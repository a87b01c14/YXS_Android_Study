...
/**
 * 带删除按钮的EditText
 * Created by xiaosanyu on 15/10/29.
 */
public class EditTextWithDel extends EditText {
    ...
    private void init() {
        ...
        imgAble_width = BitmapFactory.decodeResource(this.getResources(), R.mipmap.delete)
                .getWidth();
...
//            Log.e(TAG, "eventX = " + eventX + "; eventY = " + eventY);
            ...
            rect.left = rect.right - imgAble_width;
